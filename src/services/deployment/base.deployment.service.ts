...
/**
 * Base Deployment Service Class
 * Provides static methods for common deployment operations
 */
export class BaseDeploymentService {
  /**
   ...
   */
  static validateDeploymentParams(params: DeploymentParams): { valid: boolean; error?: string } {
    if (!params.rpcUrl) {
...
export const deployContract = BaseDeploymentService.deployContract;
export const validateDeploymentParams = BaseDeploymentService.validateDeploymentParams;
